...
class HyperLocalService {
  ...
  private createHyperLocalArticle(
    ...
    return {
      ...
      source: 'HyperLocal',
      sourceUrl: `https://example.com/${location.city.toLowerCase()}-${topic}`,
  ...
  private createPOIArticle(
    ...
    return {
      ...
      sourceUrl: `https://example.com/${location.city.toLowerCase()}-poi`,
  ...
  private createEventArticle(
    ...
    return {
      ...
      sourceUrl: `https://example.com/${location.city.toLowerCase()}-events`,
